...
pub enum Commands {
    ...
    /// Import an external (file or url) hostfile into your hostfile
    Import {
        /// Indicate that you really want to import the external hostfile, you need to explicitly set it to true
        #[clap(short='d', long)]
        dry_run: bool,
        
        /// External file to import, can either be a filename or a url
        #[clap(required = true)]
        filename: String,
    },
}
